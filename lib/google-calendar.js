...
export async function createCalendarEvent(
  ...
  const event = {
    ...
    /*
     * This asks Google Calendar to create
     * a Google Meet conference for the event.
     */
    conferenceData: {
      createRequest: {
        requestId:
  ...
  /*
   * Add the client as a Calendar attendee.
   */
  if (attendeeEmail) {
    event.attendees = [
      {
  ...
  /*
   * Google can expose the Meet URL in different
   * places depending on the event response.
   */
